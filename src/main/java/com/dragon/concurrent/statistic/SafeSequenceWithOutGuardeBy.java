 ...
 */
public class SafeSequenceWithOutGuardeBy {

	private static Logger logger = LogManager.getLogger(SafeSequenceWithOutGuardeBy.class);

	// @GuardedBy("this")
	private int value;

	private static SafeSequenceWithOutGuardeBy safeSequence = new SafeSequenceWithOutGuardeBy();
	...
	public static SafeSequenceWithOutGuardeBy getInstance() {
		return safeSequence;
	}
}
